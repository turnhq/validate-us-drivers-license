...
module.exports = {
  ...
  CO: [
    ...
    },
    {
      ...
      description: "ANNNNNN min length 4 max 7",
    },
    {
      regex: /^[A-Z]{2}[0-9]{1,5}$/i,
      description: "AANNNNN min length 3 max 7",
    },
  ],
  CT: [
    {
  ...
  ID: [
    {
      ...
      description:
        "License must be 2 letters followed by 6 numbers followed by 1 letter",
    },
    {
      regex: /^[0-9]{9}$/i,
      description: "License must be 9 numbers",
  ...
  IA: [
    ...
    },
    {
      ...
      description:
        "License must be 3 numbers followed by 2 letters followed by 4 numbers",
    },
  ],
  KS: [
    {
  ...
  MD: [
    {
      regex: /^[A-Z]{1,2}[0-9]{11,12}$/i,
      description:
        "License must be 1 or 2 letters followed by 11 or 12 numbers",
    },
  ],
  MA: [
    {
      ...
      description:
        "License must be 1 letter followed by 8 numbers or 2 letters followed by 7 numbers",
    },
  ],
  MI: [
    {
  ...
  MO: [
    ...
    },
    {
      ...
      description:
        'License must be 1 letter followed by 6 numbers followed by "R"',
    },
    {
      regex: /^[0-9]{9}[A-Z]{1}$/i,
    ...
    },
    {
      ...
      description:
        "ANNNNNA MinLength = 7 MaxLength = 7 OR ANNNNNA MinLength = 8 MaxLength = 8",
    },
  ],
  MT: [
    {
  ...
  NH: [
    {
      ...
      description:
        "License must be 2 numbers followed by 3 letters followed by 5 numbers OR 3 letters followed by 8 numbers",
    },
  ],
  NJ: [
    {
  ...
  NY: [
    ...
    {
      regex: /^[A-Z]{1}[0-9]{17,18}$/i,
      description: "License must be 1 letter followed by 17-18 numbers",
    },
    {
      regex: /^[0-9]{8,9}$/i,
      description: "License must be 8-9 numbers",
  ...
  VT: [
    ...
    },
    {
      regex: /^\d{7}[A-Z]?$/i,
      description:
        "NNNNNNNA MinLength = 8 MaxLength = 8 OR NNNNNNN MinLength = 7 MaxLength = 7",
    },
  ],
  VA: [
    {
  ...
  WA: [
    {
      ...
      description:
        'License must be 1-7 letters followed by any combination of letters, numbers, or "*" for a total of 12 characters',
    },
    {
      regex: /^[A-Z0-9]{12}$/i,
  ...
  WV: [
    ...
    },
    {
      regex: /^[A-Z]{2}\d{5,6}$/i,
      description:
        "AANNNNN MinLength = 7 MaxLength = 7 OR AANNNNNN MinLength = 8 MaxLength = 8",
    },
    {
      regex: /^\d[A-Z]\d{5}$/i,
